...
추상클래스는 미완성 메서드를 포함하고 있는 클래스로 인스턴스 생성은 불가능하며 다른 클래스인 자속 클래스를 작성하는데 도움을 줄 목적으로 작성합니다. 또한 단일 상속만 가능합니다.
...
다양한 타입의 객체들을 다루는 method나 collection에서 컴파일 타임 시 객체 타입체크를 해주는 기능입니다.
