...
- **Python Programming for SL**
    ...
    - matplotlib : 2차원 그래프를 그려주기 위함입니다.
...
- **Model Accuracy 평가**
    ...
    - 과한 트레이닝 데이터 fitting은 Error까지 fitting 하여 **overfit** 즉, 정확성이 떨어질 수 있습니다.
    
    - fresh test(새로운 데이터를 이용)를 해야합니다.

    - 손실함수, MSE : Mean Squared Error
    <p align="center"><img src="images/mse.png" width="50%"></p>
...
- **Classification Problem**
    ...
    - Bayes optimal classifier : conditional class probabilities를 최대화 할 수 있는 값을 선택합니다.
    - KNN, K-nearest Neighbors : Bayes classifier를 실제 환경에 맞춰둔 것입니다.
